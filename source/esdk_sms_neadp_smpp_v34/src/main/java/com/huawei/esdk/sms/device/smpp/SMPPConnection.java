...
public class SMPPConnection extends DeviceConnectionBase
{
    private static final Logger LOGGER = Logger.getLogger(SMPPConnection.class);
    
    private MultiConnDeviceBase device;
    
    protected SMPPConnection(String user, String pwd, MultiConnDeviceBase serviceProxy)
    {
        super(user, pwd);
