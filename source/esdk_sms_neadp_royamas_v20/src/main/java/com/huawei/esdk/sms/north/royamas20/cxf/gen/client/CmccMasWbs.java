...
public interface CmccMasWbs {
    ...
    @WebResult(name = "startNotificationRequestResponse", targetNamespace = "http://www.csapi.org/schema/notification", partName = "startNotificationRequestResponse")
    @WebMethod(action = "http://www.csapi.org/service/startNotification")
    public StartNotificationRequestResponse startNotification(
