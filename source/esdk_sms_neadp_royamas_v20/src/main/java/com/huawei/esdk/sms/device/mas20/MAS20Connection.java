...
public class MAS20Connection extends DeviceConnectionBase
{
    private static final Logger LOGGER = Logger.getLogger(MAS20Connection.class);
    
    private MultiConnDeviceBase device;
    
    protected MAS20Connection(String user, String pwd, MultiConnDeviceBase serviceProxy)
    {
        super(user, pwd);
